...
mframe_t arachnid_psx_frames_stand[] = {
	{ ai_stand },
	{ ai_stand },
	{ ai_stand },
	{ ai_stand },
...
MMOVE_T(arachnid_psx_move_stand) = { FRAME_idle1, FRAME_idle13, arachnid_psx_frames_stand, nullptr };
...
void arachnid_psx_footstep(edict_t* self)
{
	gi.sound(self, CHAN_BODY, sound_step, 0.5f, ATTN_IDLE, 0.0f);
}

mframe_t arachnid_psx_frames_walk[] = {
	{ ai_walk, 2, arachnid_psx_footstep },
	{ ai_walk, 5 },
	{ ai_walk, 12 },
	{ ai_walk, 16 },
	{ ai_walk, 5 },
	{ ai_walk, 8, arachnid_psx_footstep },
	{ ai_walk, 8 },
	{ ai_walk, 12 },
	{ ai_walk, 9 },
	{ ai_walk, 5 }
...
mframe_t arachnid_psx_frames_run[] = {
	{ ai_run, 2, arachnid_psx_footstep },
	{ ai_run, 5 },
	{ ai_run, 12 },
	{ ai_run, 16 },
	{ ai_run, 5 },
	{ ai_run, 8, arachnid_psx_footstep },
	{ ai_run, 8 },
	{ ai_run, 12 },
	{ ai_run, 9 },
	{ ai_run, 5 }
...
mframe_t arachnid_psx_frames_pain1[] = {
	{ ai_move },
	{ ai_move },
	{ ai_move },
	{ ai_move },
...
MMOVE_T(arachnid_psx_move_pain1) = { FRAME_pain11, FRAME_pain15, arachnid_psx_frames_pain1, arachnid_psx_run };

mframe_t arachnid_psx_frames_pain2[] = {
	{ ai_move },
	{ ai_move },
	{ ai_move },
	{ ai_move },
...
MMOVE_T(arachnid_psx_move_pain2) = { FRAME_pain21, FRAME_pain26, arachnid_psx_frames_pain2, arachnid_psx_run };
...
void arachnid_psx_melee_charge(edict_t* self)
{
...
mframe_t arachnid_psx_frames_melee[] = {
	...
	{ ai_charge },
	{ ai_charge },
	{ ai_charge, 0, arachnid_psx_melee_charge },
	{ ai_charge },
...
void arachnid_psx_dead(edict_t* self)
{
	self->mins = { -16, -16, -24 };
	self->maxs = { 16, 16, -8 };
...
mframe_t arachnid_psx_frames_death1[] = {
	{ ai_move, 0 },
	{ ai_move, -1.23f },
	{ ai_move, -1.23f },
	{ ai_move, -1.23f },
...
MMOVE_T(arachnid_psx_move_death) = { FRAME_death1, FRAME_death20, arachnid_psx_frames_death1, arachnid_psx_dead };
