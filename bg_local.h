...
constexpr int MAX_MONSTER_CONFIGSTRINGS = 57;
constexpr int MAX_CTF_ID_VIEW_CONFIGSTRINGS = 84;
...
enum {
	...
	CONFIG_N64_PHYSICS,
	CONFIG_HEALTH_BAR_NAME,
	CONFIG_STORY,
	CONFIG_MONSTER_HEALTH_BASE = CONFIG_CTF_TEAMINFO + 1,
	...
	CONFIG_VOTE_INFO,  // Añadir un nuevo configstring para la información de la votación
	CONFIG_LAST
};
