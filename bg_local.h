...
constexpr int MAX_MONSTER_CONFIGSTRINGS = 80;
constexpr int MAX_CTF_ID_VIEW_CONFIGSTRINGS = 100;
constexpr int MAX_MISC_CONFIGSTRINGS = 20;

enum {
	CONFIG_CTF_PLAYER_NAME = CS_GENERAL,
	CONFIG_CTF_PLAYER_NAME_END = CONFIG_CTF_PLAYER_NAME + MAX_CLIENTS - 1,
	CONFIG_COOP_RESPAWN_STRING = CONFIG_CTF_PLAYER_NAME_END + 1,
	CONFIG_COOP_RESPAWN_STRING_END = CONFIG_COOP_RESPAWN_STRING + COOP_RESPAWN_TOTAL - 1,
	CONFIG_HEALTH_BAR_NAME = CONFIG_COOP_RESPAWN_STRING_END + 1,
	CONFIG_STORY = CONFIG_HEALTH_BAR_NAME + 1,
	CONFIG_HORDEMSG = CONFIG_STORY + 1,
	CONFIG_MONSTER_HEALTH_BASE = CONFIG_HORDEMSG + 1,
	CONFIG_MONSTER_HEALTH_END = CONFIG_MONSTER_HEALTH_BASE + MAX_MONSTER_CONFIGSTRINGS - 1,
	CONFIG_PLAYER_HEALTH_BASE = CONFIG_MONSTER_HEALTH_END + 1,
	CONFIG_PLAYER_HEALTH_END = CONFIG_PLAYER_HEALTH_BASE + MAX_PLAYER_CONFIGSTRINGS - 1,
	CONFIG_CTF_ID_VIEW_START = CONFIG_PLAYER_HEALTH_END + 1,
	CONFIG_CTF_ID_VIEW_END = CONFIG_CTF_ID_VIEW_START + MAX_CTF_ID_VIEW_CONFIGSTRINGS - 1,
	CONFIG_VOTE_INFO = CONFIG_CTF_ID_VIEW_END + 1,
	CONFIG_MISC_BASE = CONFIG_VOTE_INFO + 1,
	CONFIG_MISC_END = CONFIG_MISC_BASE + MAX_MISC_CONFIGSTRINGS - 1,
	CONFIG_LAST = CONFIG_MISC_END + 1
};
...
enum player_stat_t
{
	...
	STAT_CTF_ID_VIEW = 28,
	STAT_CTF_MATCH = 29,
	STAT_SPREE = 30, //unused atm



	// [Kex] More stats for weapon wheel
	STAT_WEAPONS_OWNED_1 = 31,
	STAT_WEAPONS_OWNED_2 = 32,
	STAT_AMMO_INFO_START = 33,
