...
constexpr int MAX_MONSTER_CONFIGSTRINGS = 63; // Incrementado de 75 a 100
constexpr int MAX_CTF_ID_VIEW_CONFIGSTRINGS = 87;
...
enum {
	...
	CONFIG_STORY,
	CONFIG_HORDEMSG,
	CONFIG_MONSTER_HEALTH_BASE = CS_GENERAL + 1,
