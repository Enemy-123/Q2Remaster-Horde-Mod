...
enum
{
	CONFIG_CTF_PLAYER_NAME = CS_GENERAL, // Iniciamos desde CS_GENERAL para nombres de jugadores
	CONFIG_CTF_PLAYER_NAME_END = CONFIG_CTF_PLAYER_NAME + MAX_CLIENTS, // Espacio para 16 jugadores

	CONFIG_COOP_RESPAWN_STRING, // Para reaparición cooperativa
	CONFIG_COOP_RESPAWN_STRING_END = CONFIG_COOP_RESPAWN_STRING + (COOP_RESPAWN_TOTAL - 1),

	CONFIG_HEALTH_BAR_NAME, // Nombre de la barra de salud activa

	// Reservamos un rango específico para los configstrings de los monstruos y trampas
	CONFIG_MONSTER_HEALTH_BASE,
	CONFIG_MONSTER_HEALTH_END = CONFIG_MONSTER_HEALTH_BASE + MAX_MONSTER_CONFIGSTRINGS - 1,

	CONFIG_STORY, // Configuración de historia después de los monstruos

	CONFIG_PLAYER_HEALTH_BASE = CONFIG_STORY + 1,
