...
enum {
	...
	CONFIG_HEALTH_BAR_NAME = CS_GENERAL + CS_BOSS - 1,
	CONFIG_STORY,
	CONFIG_HORDEMSG,
...
static_assert(CONFIG_MONSTER_HEALTH_BASE > CONFIG_HORDEMSG, "Configstrings overlap detected.");
static_assert(CONFIG_PLAYER_HEALTH_BASE > CONFIG_MONSTER_HEALTH_END, "Configstrings overlap detected.");
static_assert(CONFIG_CTF_ID_VIEW_START > CONFIG_PLAYER_HEALTH_END, "Configstrings overlap detected.");
static_assert(CONFIG_LAST <= CS_GENERAL + MAX_GENERAL, "configstrings too big");
