...
static mframe_t guardianpsx_frames_stand[] = {
	{ ai_stand },
	{ ai_stand },
	{ ai_stand },
	{ ai_stand },
...
MMOVE_T(guardianpsx_move_stand) = { FRAME_idle1, FRAME_idle52, guardianpsx_frames_stand, nullptr };
...
static mframe_t guardianpsx_frames_sleep[] = {
	{ ai_sleep },
	{ ai_sleep },
	{ ai_sleep },
	{ ai_sleep },
...
MMOVE_T(guardianpsx_move_sleep) = { FRAME_sleep1, FRAME_sleep14, guardianpsx_frames_sleep, nullptr };

MONSTERINFO_STAND(guardianpsx_stand) (edict_t* self) -> void
{
	if (self->spawnflags.has(SPAWNFLAG_GUARDIAN_SLEEPY))
		M_SetAnimation(self, &guardianpsx_move_sleep);
	else
		M_SetAnimation(self, &guardianpsx_move_stand);
}

void guardianpsx_run(edict_t* self);

static mframe_t guardianpsx_frames_wake[] = {
	{ ai_sleep },
	{ ai_sleep },
	{ ai_sleep },
	{ ai_sleep },
...
MMOVE_T(guardianpsx_move_wake) = { FRAME_wake1, FRAME_wake5, guardianpsx_frames_wake, guardianpsx_run };

USE(guardianpsx_use) (edict_t* self, edict_t* other, edict_t* activator) -> void
{
	self->spawnflags &= ~SPAWNFLAG_GUARDIAN_SLEEPY;
	M_SetAnimation(self, &guardianpsx_move_wake);
...
static mframe_t guardianpsx_frames_walk[] = {
	{ ai_walk, 8 },
	{ ai_walk, 8 },
	{ ai_walk, 8 },
	{ ai_walk, 8 },
	...
	{ ai_walk, 8 },
	{ ai_walk, 8 },
	{ ai_walk, 8, guardianpsx_footstep },
	{ ai_walk, 8 },
	{ ai_walk, 8 },
	{ ai_walk, 8 },
	{ ai_walk, 8 },
...
MMOVE_T(guardianpsx_move_walk) = { FRAME_walk1, FRAME_walk19, guardianpsx_frames_walk, nullptr };

MONSTERINFO_WALK(guardianpsx_walk) (edict_t* self) -> void
{
	M_SetAnimation(self, &guardianpsx_move_walk);
}
...
static mframe_t guardianpsx_frames_run[] = {
	{ ai_run, 8 },
	{ ai_run, 8 },
	{ ai_run, 8 },
	{ ai_run, 8 },
...
MMOVE_T(guardianpsx_move_run) = { FRAME_walk1, FRAME_walk19, guardianpsx_frames_run, nullptr };

MONSTERINFO_RUN(guardianpsx_run) (edict_t* self) -> void
{
	...
	M_SetAnimation(self, &guardianpsx_move_run);
}
...
static mframe_t guardianpsx_frames_pain1[] = {
	{ ai_move },
	{ ai_move },
	{ ai_move },
	{ ai_move },
...
MMOVE_T(guardianpsx_move_pain1) = { FRAME_pain1_1, FRAME_pain1_8, guardianpsx_frames_pain1, guardianpsx_run };

PAIN(guardianpsx_pain) (edict_t* self, edict_t* other, float kick, int damage, const mod_t& mod) -> void
{
	...
	M_SetAnimation(self, &guardianpsx_move_pain1);
	self->monsterinfo.weapon_sound = 0;
	self->monsterinfo.aiflags &= ~AI_MANUAL_STEERING;
}

static mframe_t guardianpsx_frames_atk1_out[] = {
	{ ai_charge },
	{ ai_charge },
	{ ai_charge }
};
...
static mframe_t guardianpsx_frames_atk1_spin[] = {
	{ ai_charge, 0, guardianpsx_atk1_charge },
	{ ai_charge },
	{ ai_charge },
	{ ai_charge },
	{ ai_charge, 0, guardianpsx_fire_blaster },
	{ ai_charge, 0, guardianpsx_fire_blaster },
	{ ai_charge, 0, guardianpsx_fire_blaster },
	{ ai_charge, 0, guardianpsx_fire_blaster },
	{ ai_charge, 0, guardianpsx_fire_blaster },
...
static mframe_t guardianpsx_frames_atk1_in[] = {
	{ ai_charge },
	{ ai_charge },
	{ ai_charge }
};
MMOVE_T(guardianpsx_move_atk1_in) = { FRAME_atk1_in1, FRAME_atk1_in3, guardianpsx_frames_atk1_in, guardianpsx_atk1 };

static mframe_t guardianpsx_frames_atk2_out[] = {
	{ ai_charge },
	{ ai_charge },
	{ ai_charge },
	{ ai_charge },
	{ ai_charge, 0, guardianpsx_footstep },
	{ ai_charge },
	{ ai_charge }
};
...
PRETHINK(guardianpsx_fire_update) (edict_t* laser) -> void
{
...
static mframe_t guardianpsx_frames_atk2_fire[] = {
	{ ai_charge, 0, guardianpsx_laser_fire },
	{ ai_charge, 0, guardianpsx_laser_fire },
	{ ai_charge, 0, guardianpsx_laser_fire },
	{ ai_charge, 0, guardianpsx_laser_fire }
};
...
static mframe_t guardianpsx_frames_atk2_in[] = {
	{ ai_charge, 0, guardianpsx_footstep },
	{ ai_charge },
	{ ai_charge },
	{ ai_charge, 0, guardianpsx_footstep },
...
static mframe_t guardianpsx_frames_kick[] = {
	{ ai_charge, 12.f },
	{ ai_charge, 18.f, guardianpsx_footstep },
	{ ai_charge, 11.f },
	{ ai_charge, 9.f },
	{ ai_charge, 8.f },
	{ ai_charge, 0, guardianpsx_kick },
	{ ai_charge },
	{ ai_charge },
	{ ai_charge },
	{ ai_charge },
...
MMOVE_T(guardianpsx_move_kick) = { FRAME_kick_in1, FRAME_kick_in13, guardianpsx_frames_kick, guardianpsx_run };
...
static void guardianpsx_fire_rocket_l(edict_t* self)
{
	guardianpsx_fire_rocket(self, -14.0f);
}

static void guardianpsx_fire_rocket_r(edict_t* self)
{
	guardianpsx_fire_rocket(self, 14.0f);
}

static void guardianpsx_blind_fire_check(edict_t* self)
{
...
MMOVE_T(guardianpsx_move_rocket) = { FRAME_turnl_1, FRAME_turnr_11, guardianpsx_frames_rocket, guardianpsx_run };
...
MONSTERINFO_ATTACK(guardianpsx_attack) (edict_t* self) -> void
{
	...
	else if (r > 300.f && frandom() < (max(r, 1000.f) / 1200.f))
	{
		...
		{
			M_SetAnimation(self, &guardianpsx_move_atk2_in);
			self->style = 1;
			changedAttack = true;
...
void guardianpsx_dead(edict_t* self)
{
	for (int i = 0; i < 3; i++)
		guardianpsx_explode(self);
...
static mframe_t guardianpsx_frames_death1[FRAME_death26 - FRAME_death1 + 1] = {
...
MMOVE_T(guardianpsx_move_death) = { FRAME_death1, FRAME_death26, guardianpsx_frames_death1, guardianpsx_dead };

DIE(guardianpsx_die) (edict_t* self, edict_t* inflictor, edict_t* attacker, int damage, const vec3_t& point, const mod_t& mod) -> void
{
	if (self->deadflag)
		return;
...
MONSTERINFO_SETSKIN(guardianpsx_setskin) (edict_t* self) -> void
{
...
/*QUAKED monster_psxguardian (1 .5 0) (-96 -96 -66) (96 96 62) Ambush Trigger_Spawn Sight
 */
void SP_monster_psxguardian(edict_t* self)
{
	...
	self->pain = guardianpsx_pain;
	self->die = guardianpsx_die;
	self->monsterinfo.stand = guardianpsx_stand;
	self->monsterinfo.walk = guardianpsx_walk;
	self->monsterinfo.run = guardianpsx_run;
	self->monsterinfo.attack = guardianpsx_attack;
	self->monsterinfo.checkattack = Guardian_CheckAttack;
	self->monsterinfo.setskin = guardianpsx_setskin;
	...
	guardianpsx_stand(self);

	walkmonster_start(self);

	self->use = guardianpsx_use;
