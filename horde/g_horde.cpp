...
constexpr struct weighted_item_t {
	...
	{ "item_ir_goggles", -1, -1, 0.024f, adjust_weight_powerup },
	{ "item_quad", 6, -1, 0.052f, adjust_weight_powerup },
	{ "item_double", 4, -1, 0.06f, adjust_weight_powerup },
	{ "item_quadfire", 2, -1, 0.05f, adjust_weight_powerup },
	{ "item_invulnerability", 4, -1, 0.04f, adjust_weight_powerup },
	...
	{ "weapon_chainfist", -1, 3, 0.08f, adjust_weight_weapon },
...
static void SetMonsterArmor(edict_t* monster) {
	...
	if (!st.was_key_specified("power_armor_power")) {
		...
		if (current_wave_level <= 15) {
			level_scaling = 1.0f + (current_wave_level * 0.08f);
		}
		else if (current_wave_level <= 25) {
			level_scaling = 2.2f + ((current_wave_level - 15) * 0.12f);
		}
		else {
			level_scaling = 3.4f + ((current_wave_level - 25) * 0.15f);
		}
